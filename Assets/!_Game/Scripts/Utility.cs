...
namespace Mutrix { 
    public class Utility  {
        ...
        /// From http://answers.unity3d.com/questions/134413/how-do-i-render-only-a-part-of-the-cameras-view.html
        /// </summary>
        /// <param name="cam">The Camera the rect will be set to</param>
